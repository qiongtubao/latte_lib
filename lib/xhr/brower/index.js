...
Request.prototype._end = function () {
    ...
    if (!this._formData && 'GET' != this.method && 'HEAD' != this.method && 'string' != typeof data && !this._isHost(data)) {
        ...
        var serialize_1 = this._serializer || request.serialize[contentType ? contentType.split(';')[0] : ''];
        if (!serialize_1 && isJSON(contentType)) {
            serialize_1 = request.serialize['application/json'];
        }
        if (serialize_1)
            data = serialize_1(data);
    }

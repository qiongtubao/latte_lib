...
var isNode = isWindow ? false : global.process ? true : false;
...
var undefineds = function (array) {
    var map = [];
    for (var i = 0, len = array[0]; i < len; i++) {
        map.push(undefined);
    }
    return map;
};
...
exports.default = {
    ...
    isString: isString, isError: isError, isRegExp: isRegExp, isSymbol: isSymbol, isNull: isNull, isNullOrUndefined: isNullOrUndefined,

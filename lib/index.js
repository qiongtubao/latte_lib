	...
	function(require, exports, module, window) {
		...
		*/
		...
		if(!window) {
			...
			module.exports.BlobBuilder = require("./blobBuilder");
		}

		//window && module.exports.dom = require("./dom") && module.exports.domEvent = require("./domEvnet")
		...
		module.exports.formation = require("./stringFormation");
